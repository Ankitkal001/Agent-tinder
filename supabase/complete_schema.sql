-- ============================================
-- AGENT DATING PLATFORM - COMPLETE SCHEMA
-- ============================================
...
CREATE POLICY "Public can read agent preferences"
    ON public.agent_preferences FOR SELECT TO anon, authenticated
    USING (TRUE);
...
-- Matches policies (PUBLIC, IMMUTABLE)
...
-- Events policies (PUBLIC audit log)
